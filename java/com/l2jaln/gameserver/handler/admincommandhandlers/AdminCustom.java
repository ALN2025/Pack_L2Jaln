...
import com.l2jaln.gameserver.NewZoneVote;
...
import com.l2jaln.gameserver.instancemanager.VIPINFO;
...
import com.l2jaln.gameserver.network.serverpackets.AutoAttackStart;
import com.l2jaln.gameserver.network.serverpackets.AutoAttackStop;
import com.l2jaln.gameserver.network.serverpackets.OpenUrl;
import com.l2jaln.gameserver.network.serverpackets.TutorialCloseHtml;
import com.l2jaln.gameserver.network.serverpackets.TutorialShowHtml;
...
import com.l2jaln.commons.util.StringUtil;
...
public class AdminCustom implements IAdminCommandHandler
{
	...
	private static void initEventArena()
	{
		ThreadPool.schedule(new Runnable()
		{
			...
			public void run()
			{
				com.l2jaln.events.ArenaTask.SpawnEvent();
			}
	...
	private static void finishEventArena()
	{
		ThreadPool.schedule(new Runnable()
		{
			...
			public void run()
			{
				com.l2jaln.events.ArenaTask.finishEvent();
			}
	...
	private static void finishPartyZone()
	{
		ThreadPool.schedule(new Runnable()
		{
			...
			public void run()
			{
				com.l2jaln.events.PartyZoneTask.finishEvent();
			}
		}, 1);
	}
