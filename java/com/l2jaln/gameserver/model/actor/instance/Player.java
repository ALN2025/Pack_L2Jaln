...
import com.l2jaln.events.pvpevent.PvPEvent;
import com.l2jaln.gameserver.LoginServerThread;
import com.l2jaln.gameserver.communitybbs.BB.Forum;
...
import com.l2jaln.gameserver.data.xml.FishData;
import com.l2jaln.gameserver.data.xml.HennaData;
import com.l2jaln.gameserver.data.xml.PkColorTable;
import com.l2jaln.gameserver.data.xml.PkColorTable.PkColor;
import com.l2jaln.gameserver.data.xml.PvpColorTable;
import com.l2jaln.gameserver.data.xml.PvpColorTable.PvpColor;
...
import com.l2jaln.gameserver.handler.admincommandhandlers.AdminEditChar;
...
import com.l2jaln.gameserver.instancemanager.ChatBanManager;
import com.l2jaln.gameserver.instancemanager.ChatGlobalManager;
import com.l2jaln.gameserver.instancemanager.ChatHeroManager;
...
import com.l2jaln.gameserver.instancemanager.HeroManager;
...
import com.l2jaln.gameserver.instancemanager.VipManager;
import com.l2jaln.gameserver.instancemanager.VoteZone;
import com.l2jaln.gameserver.instancemanager.ZoneManager;
import com.l2jaln.gameserver.model.AccessLevel;
...
import com.l2jaln.gameserver.model.Fish;
import com.l2jaln.gameserver.model.L2Effect;
import com.l2jaln.gameserver.model.L2Fishing;
import com.l2jaln.gameserver.model.L2Macro;
import com.l2jaln.gameserver.model.L2ManufactureList;
import com.l2jaln.gameserver.model.L2Party;
import com.l2jaln.gameserver.model.L2Party.MessageType;
import com.l2jaln.gameserver.model.L2Radar;
import com.l2jaln.gameserver.model.L2Request;
import com.l2jaln.gameserver.model.L2ShortCut;
import com.l2jaln.gameserver.model.L2Skill;
import com.l2jaln.gameserver.model.L2Skill.SkillTargetType;
import com.l2jaln.gameserver.model.L2SkillLearn;
import com.l2jaln.gameserver.model.MacroList;
import com.l2jaln.gameserver.model.PetDataEntry;
import com.l2jaln.gameserver.model.ShortCuts;
...
import com.l2jaln.gameserver.model.actor.ai.NextAction;
import com.l2jaln.gameserver.model.actor.ai.type.CreatureAI;
import com.l2jaln.gameserver.model.actor.ai.type.PlayerAI;
...
import com.l2jaln.gameserver.model.actor.status.PlayerStatus;
...
import com.l2jaln.gameserver.model.holder.SkillUseHolder;
import com.l2jaln.gameserver.model.item.Henna;
import com.l2jaln.gameserver.model.item.RecipeList;
...
import com.l2jaln.gameserver.model.item.kind.Armor;
...
import com.l2jaln.gameserver.model.itemcontainer.PcFreight;
...
import com.l2jaln.gameserver.model.memo.PlayerMemo;
import com.l2jaln.gameserver.model.multisell.PreparedListContainer;
...
import com.l2jaln.gameserver.network.serverpackets.AbstractNpcInfo;
import com.l2jaln.gameserver.network.serverpackets.ActionFailed;
import com.l2jaln.gameserver.network.serverpackets.ChairSit;
import com.l2jaln.gameserver.network.serverpackets.ChangeWaitType;
import com.l2jaln.gameserver.network.serverpackets.CharInfo;
...
import com.l2jaln.gameserver.network.serverpackets.EtcStatusUpdate;
import com.l2jaln.gameserver.network.serverpackets.ExAutoSoulShot;
import com.l2jaln.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import com.l2jaln.gameserver.network.serverpackets.ExFishingEnd;
import com.l2jaln.gameserver.network.serverpackets.ExFishingStart;
import com.l2jaln.gameserver.network.serverpackets.ExOlympiadMode;
import com.l2jaln.gameserver.network.serverpackets.ExPCCafePointInfo;
import com.l2jaln.gameserver.network.serverpackets.ExSetCompassZoneCode;
import com.l2jaln.gameserver.network.serverpackets.ExShowScreenMessage;
import com.l2jaln.gameserver.network.serverpackets.ExStorageMaxCount;
import com.l2jaln.gameserver.network.serverpackets.FriendList;
...
import com.l2jaln.gameserver.network.serverpackets.HennaInfo;
...
import com.l2jaln.gameserver.network.serverpackets.LeaveWorld;
...
import com.l2jaln.gameserver.network.serverpackets.MyTargetSelected;
import com.l2jaln.gameserver.network.serverpackets.NpcHtmlMessage;
import com.l2jaln.gameserver.network.serverpackets.ObservationMode;
import com.l2jaln.gameserver.network.serverpackets.ObservationReturn;
import com.l2jaln.gameserver.network.serverpackets.PartySmallWindowUpdate;
...
import com.l2jaln.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import com.l2jaln.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import com.l2jaln.gameserver.network.serverpackets.PrivateStoreListBuy;
import com.l2jaln.gameserver.network.serverpackets.PrivateStoreListSell;
import com.l2jaln.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import com.l2jaln.gameserver.network.serverpackets.PrivateStoreManageListSell;
import com.l2jaln.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import com.l2jaln.gameserver.network.serverpackets.PrivateStoreMsgSell;
import com.l2jaln.gameserver.network.serverpackets.RecipeShopManageList;
import com.l2jaln.gameserver.network.serverpackets.RecipeShopMsg;
import com.l2jaln.gameserver.network.serverpackets.RecipeShopSellList;
import com.l2jaln.gameserver.network.serverpackets.RelationChanged;
import com.l2jaln.gameserver.network.serverpackets.Ride;
import com.l2jaln.gameserver.network.serverpackets.SendTradeDone;
...
import com.l2jaln.gameserver.network.serverpackets.ShortBuffStatusUpdate;
import com.l2jaln.gameserver.network.serverpackets.ShortCutInit;
import com.l2jaln.gameserver.network.serverpackets.SkillCoolTime;
import com.l2jaln.gameserver.network.serverpackets.SkillList;
import com.l2jaln.gameserver.network.serverpackets.SocialAction;
import com.l2jaln.gameserver.network.serverpackets.SpawnItem;
import com.l2jaln.gameserver.network.serverpackets.StaticObjectInfo;
...
import com.l2jaln.gameserver.network.serverpackets.TargetSelected;
import com.l2jaln.gameserver.network.serverpackets.TargetUnselected;
import com.l2jaln.gameserver.network.serverpackets.TitleUpdate;
import com.l2jaln.gameserver.network.serverpackets.TradePressOtherOk;
import com.l2jaln.gameserver.network.serverpackets.TradePressOwnOk;
import com.l2jaln.gameserver.network.serverpackets.TradeStart;
...
import com.l2jaln.gameserver.skills.effects.EffectTemplate;
import com.l2jaln.gameserver.skills.funcs.FuncHennaCON;
import com.l2jaln.gameserver.skills.funcs.FuncHennaDEX;
import com.l2jaln.gameserver.skills.funcs.FuncHennaINT;
import com.l2jaln.gameserver.skills.funcs.FuncHennaMEN;
import com.l2jaln.gameserver.skills.funcs.FuncHennaSTR;
import com.l2jaln.gameserver.skills.funcs.FuncHennaWIT;
import com.l2jaln.gameserver.skills.funcs.FuncMaxCpMul;
import com.l2jaln.gameserver.skills.l2skills.L2SkillSiegeFlag;
import com.l2jaln.gameserver.skills.l2skills.L2SkillSummon;
import com.l2jaln.gameserver.taskmanager.AttackStanceTaskManager;
...
import com.l2jaln.gameserver.taskmanager.WaterTaskManager;
...
import com.l2jaln.util.CloseUtil;
...
public class Player extends Playable
{
	...
	/**
	 * @see com.l2jaln.gameserver.model.actor.Creature#enableSkill(com.l2jaln.gameserver.model.L2Skill)
	 */
	@Override
