...
import com.l2jaln.gameserver.model.zone.type.L2DerbyTrackZone;
import com.l2jaln.gameserver.network.SystemMessageId;
import com.l2jaln.gameserver.network.serverpackets.DeleteObject;
import com.l2jaln.gameserver.network.serverpackets.MonRaceInfo;
	...
	public void newRace()
	{
		...
		for (int i = 0; i < 8; i++)
		{
			try
			{
				...
				_constructor = Class.forName("com.l2jaln.gameserver.model.actor.instance." + template.getType()).getConstructors()[0];
